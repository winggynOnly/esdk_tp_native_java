 ...
 * 2013-10-08T14:05:01.845+08:00
 * Generated source version: 2.6.1
 * 
 */
@WebServiceClient(name = "eSDKService", 
                  wsdlLocation = "esdk_tp_professional_native.wsdl",
...
public class ESDKService extends Service {
    ...
    static {
        URL url = ESDKService.class.getResource("esdk_tp_professional_native.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(ESDKService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "esdk_tp_professional_native.wsdl");
        }       
        WSDL_LOCATION = url;
    }
