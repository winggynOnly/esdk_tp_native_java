...
import com.huawei.esdk.tp.professional.local.impl.interceptor.MsgInInterceptor;
import com.huawei.esdk.tp.professional.local.impl.interceptor.MsgOutInterceptor;
		...
		try {
			...
			String storePassword = new String(AESCbc128Utils.decode(Base64Utils
					.getFromBASE64(PropertiesUtils
							.getValue("ssl.keystore.password"))), "UTF-8");
