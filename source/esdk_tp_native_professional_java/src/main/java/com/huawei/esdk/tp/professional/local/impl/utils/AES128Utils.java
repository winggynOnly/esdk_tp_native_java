...
public final class AES128Utils
{
    ...
    private static byte[] BT_KEY = SecureRandom.getSeed(AES_128_KEY_LEN);
    
    private static byte[] BT_IV = SecureRandom.getSeed(AES_128_KEY_LEN);
    ...
    public static String encryptPwd(String plainPwd)
    {
        try
        {
            return Base64Utils.encode(encode(getBytes(plainPwd)));
        }
