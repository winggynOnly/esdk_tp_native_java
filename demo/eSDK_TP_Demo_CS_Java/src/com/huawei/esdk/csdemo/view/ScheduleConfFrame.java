...
import com.huawei.esdk.csdemo.listener.ScheduleConfListener;
import com.huawei.esdk.csdemo.memorydb.DataBase;
import com.huawei.esdk.csdemo.utils.DateChooserJTextField;

public class ScheduleConfFrame extends JDialog
{
    ...
    // private JCheckBox supportPresenceCK = new JCheckBox();
    ...
    public ScheduleConfFrame(JFrame owner, Boolean isModal, Rectangle rectangle)
    {
        super(owner, isModal);
    ...
    public void lunchFrame()
    {
        ...
        ScheduleConfListener scheduleConfListener = new ScheduleConfListener();
        scheduleConfListener.register(this);

        this.setResizable(false);

        Rectangle rect = new Rectangle(300, 200, 350, 400);
        RecurrenceConfFrame recurrenceConfFrame = new RecurrenceConfFrame(this,
                true, rect);
    ...
    {
        this.setTitle(LabelText.schedule_conf[DataBase.getInstance()
                .getLanguageFlag()]);

        contentPane.setBorder(BorderFactory.createTitledBorder(BorderFactory
                .createEtchedBorder(), LabelText.conference_detail[DataBase
                .getInstance().getLanguageFlag()]));
        contentPane1.setBorder(BorderFactory.createTitledBorder(BorderFactory
                .createEtchedBorder(), LabelText.advance_parameters[DataBase
                .getInstance().getLanguageFlag()]));

        confIdLabel.setText(LabelText.conference_id[DataBase.getInstance()
                .getLanguageFlag()] + ":");
        confNameLabel.setText(LabelText.conference_name[DataBase.getInstance()
                .getLanguageFlag()] + ":");
        confNameLabel.setForeground(Color.RED);
        confBeginTimeLabel.setText(LabelText.conference_begin_time[DataBase
                .getInstance().getLanguageFlag()] + ":");
        confBeginTimeLabel.setForeground(Color.RED);
        confHowLongLabel.setText(LabelText.conference_keep_time[DataBase
                .getInstance().getLanguageFlag()] + ":");
        confHowLongLabel.setForeground(Color.RED);
        recurrenceLabel.setText(LabelText.recurrence_conf[DataBase
                .getInstance().getLanguageFlag()]);
        recurrenceDetailBut
                .setText(LabelText.recurrence_conference_detail[DataBase
                        .getInstance().getLanguageFlag()]);
        confHowLongUnitLabel
                .setText(LabelText.confCtol_middle_confHowLongUnitLabel[DataBase
                        .getInstance().getLanguageFlag()]);
        // site lsir
        ...
        jtablePanel.setBorder(BorderFactory.createTitledBorder(
                ...
                LabelText.site_list[DataBase.getInstance().getLanguageFlag()]));

        refreshSitesList(siteVector);

        addsiteBut.setText(LabelText.add_anonymous_site[DataBase.getInstance()
                .getLanguageFlag()]);
        addsiteBut1.setText(LabelText.add_site[DataBase.getInstance()
                .getLanguageFlag()]);

        deletesiteBut.setText(LabelText.delete_site[DataBase.getInstance()
                .getLanguageFlag()]);
        // bottom buttton
        scheConfBut.setText(LabelText.create_conf[DataBase.getInstance()
                .getLanguageFlag()]);
        closeBut.setText(LabelText.loginFrame_menuItemClose[DataBase
                .getInstance().getLanguageFlag()]);

        // high param panel

        accessCodeLabel.setText(LabelText.access_code[DataBase.getInstance()
                .getLanguageFlag()]);
        passwordLabel.setText(LabelText.loginFrame_userPswd[DataBase
                .getInstance().getLanguageFlag()]);
        chairmanPasswordLabel.setText(LabelText.scheduleConf_chairmanPwd[DataBase
                                                            .getInstance().getLanguageFlag()]);
        passwordMethodLabel.setText(LabelText.encrypt_type[DataBase
                .getInstance().getLanguageFlag()]);
        continuousPresenceLabel
                .setText(LabelText.confCtol_bottom_duohuamianTypeLabel[DataBase
                        .getInstance().getLanguageFlag()]);
        vedio1TypeLabel.setText(LabelText.aux_stream_type[DataBase
                .getInstance().getLanguageFlag()]);
        vedio2TypeLabel.setText(LabelText.video_format[DataBase.getInstance()
                .getLanguageFlag()] + ":");

        // recordType.setText(LabelText.play_record_mode[DataBase.getInstance().getLanguageFlag()]);
        //
        // supportRecordLabel
        // .setText(LabelText.play_record[DataBase.getInstance().getLanguageFlag()]);
        // supportLivingLabel.setText(LabelText.live[DataBase.getInstance().getLanguageFlag()]);
        speedRateLabel.setText(LabelText.speed[DataBase.getInstance()
                .getLanguageFlag()]);

        // supportPresenceLabel.setText("支持组播");
        // supportPresenceBut.setText("组播信息");
        // moreInfoBut.setText("其他参数");
    }
    ...
    public void initCompomentBouds()
    {
        ...
        confNameLabel.setBounds(xx + 100 + textWidth + 10, yy, labelWidth,
                labelHeight);
        confNameText.setBounds(xx + 230 + textWidth + 15, yy, 800 - labelWidth
                * 2 - textWidth - xx - 30, labelHeight);

        confBeginTimeLabel.setBounds(xx, yy + labelHeight + 10, 100,
                labelHeight);
        confBeginTimeText.setBounds(xx + 105, yy + labelHeight + 10, textWidth,
                textHeight);

        confHowLongLabel.setBounds(xx + 100 + textWidth + 10, yy + labelHeight
                + 10, labelWidth, labelHeight);
        confHowLongText.setBounds(xx + 230 + textWidth + 15, yy + labelHeight
                + 10, textWidth, labelHeight);
        confHowLongUnitLabel.setBounds(xx + 230 + 2 * textWidth + 15, yy
                + labelHeight + 10, 30, labelHeight);
        ...
        // supportPresenceCK.setBounds(10, moddlePanelHeight-labelHeight-10,
        // labelHeight, labelHeight);
        // supportPresenceLabel.setBounds(15+labelHeight,moddlePanelHeight-labelHeight-10,labelWidth,labelHeight);
        // supportPresenceBut.setBounds(10 +
        // labelWidth+15,moddlePanelHeight-labelHeight-10,100,25);
        // moreInfoBut.setBounds(moddlePanelwidth-10 - 100,
        // moddlePanelHeight-labelHeight-10,100,25);
    ...
    public void addCompomentToPanel()
    {
        ...
        // contentPane1.add(supportPresenceCK);
        // contentPane1.add(supportPresenceLabel);
        // contentPane1.add(supportPresenceBut);
        // contentPane1.add(moreInfoBut);
...
//        contentPane1.add(supportLivingLabel);
        ...
        // scheConfBut.setActionCommand("ScheduleConfFrame_ScheduleConf");
        // scheConfBut.addActionListener(this);
        // closeBut.setActionCommand("ScheduleConfFrame_Close");
        // closeBut.addActionListener(this);
        // addsiteBut1.setActionCommand("showSiteList_Command");
        // addsiteBut1.addActionListener(this);
    ...
    public void clearTable()
    {
        ...
        titles.add(LabelText.site_status[DataBase.getInstance()
                .getLanguageFlag()]);
        titles.add(LabelText.site_conn_type[DataBase.getInstance()
                .getLanguageFlag()]);
        titles.add(LabelText.site_speed[DataBase.getInstance()
                .getLanguageFlag()]);
        titles.add(LabelText.video_format[DataBase.getInstance()
                .getLanguageFlag()]);
        titles.add(LabelText.video_info[DataBase.getInstance()
                .getLanguageFlag()]);
    ...
    /**
     * 预约会议会场列表刷新 * @param selectedSites
     */
    ...
    public SelectSiteFrame getFrame()
    {
        return frame;
    }

    public void setFrame(SelectSiteFrame frame)
    {
        this.frame = frame;
    }
    ...
    public void setContinuousPresenceJC(JComboBox continuousPresenceJC)
    {
        this.continuousPresenceJC = continuousPresenceJC;
    }
