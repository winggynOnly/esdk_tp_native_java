...
*/
/**
 * updated taochunlong 2012 [ insominia@foxmail.com ]
 */
(function ($)
{
    ...
    $.ligerDefaults.Tree = {
        ...
        nodeWidth: 90,
        statusName: '__status',
        isLeaf: function (data) {return data.leaf;},              //是否子节点的判断函数    taochunlong修改
        single: false,               //是否单选
    ...
    $.ligerui.controls.Tree.ligerExtend($.ligerui.core.UIComponent, {
        ...
        {
            if (url) this.loadData(null, url,rootid);   //添加rootid   taochunlong修改
        },
