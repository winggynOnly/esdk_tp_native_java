...
var popUpCal = {
	...
	formatTypeText:'',//以要求的yyyy-MM-dd hh:mm:ss格式输出--edit by wzw
	...
	/* Format and display the given date. --原有的组装时间的方法，格式：23/07/2012 6:55PM*/
	...
	connectCalendar: function(target) {
		...
		var $input = $(target);
		//alert(this.appendText);
		$input.after('<span class="calendar_append">' + this.appendText + '</span>');
//		$input.after('<span class="calendar_append">' + this.formatTypeText + '</span>');
